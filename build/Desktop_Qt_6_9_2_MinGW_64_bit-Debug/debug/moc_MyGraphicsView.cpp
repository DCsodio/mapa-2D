...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->rangoCambiado((*reinterpret_cast< std::add_pointer_t<QRectF>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MyGraphicsView::*)(QRectF )>(_a, &MyGraphicsView::rangoCambiado, 0))
            return;
    }
}
...
// SIGNAL 0
void MyGraphicsView::rangoCambiado(QRectF _t1)
{
